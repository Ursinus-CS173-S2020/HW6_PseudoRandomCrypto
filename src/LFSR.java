...
public class LFSR {
    ...
    /**
     * Convert an into a string representing its bits.
     * This is an overloaded version that takes only the first 
     * nbits bits
     * @param x A 32-bit int
    ...
    /**
     * Pack groups of 4 bytes into an array of ints in 
     * little endian order
     * @param barray
    ...
    /**
     * Extract the bytes from an int array in little endian
     * order and copy them over to a byte array
    ...
    /**
     * Given the current state of a 32-bit LFSR and an 
     * array of the taps to use, generate the next bit
     * that will be generated by this LFSR
    ...
    /**
     * Return the state of an LFSR after 32 new bits have
     * been generated
     * 
    ...
    /**
     * This method applies XOR encryption/decryption to all of the
     * 32-bit integer values in an input array
     * Given the initial state of an LFSR and the taps, generate
     * a sequence of random ints that are XORed with each input int
     * and store that in an output array
     * @param initial The state of the LFSR before this method
     * @param taps The locations of the taps
     * @param input An array of ints representing the message
     *              to encrypt or decrypt
     * @return An array of ints representing the encrypted or
     *         decrypted message
     */
    ...
    /**
     * This is a wrapper function that takes in a string, converts
     * it to a sequence of unicode bytes, converts those bytes to
     * an int array, and calls the student method for XOR encryption
     * @param initial The state of the LFSR before this method
     * @param taps The locations of the taps
    ...
    /**
     * This is a wrapper function that reads in a text file as a string
     * and passes it along to the encryptDecryptString function
    ...
    /**
     * This is a wrapper function that takes in a string and
     * encrypts/decrypts the result, and saves it to a file
    ...
    public static void main(String[] args) {
        // TODO: Put code here that will help you
        // to make sure each module is working
    }
}
